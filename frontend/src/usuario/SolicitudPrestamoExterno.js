...
const SolicitudPrestamoExterno = () => {
  // Fechas
  ...
  const guardarImagenSolicitante = () =>
    setImageURLSolicitante(
      sigCanvasSolicitante.current.getTrimmedCanvas().toDataURL("image/png")
    );
  ...
  const guardarImagenResponsable = () =>
    setImageURLResponsable(
      sigCanvasResponsable.current.getTrimmedCanvas().toDataURL("image/png")
    );
  ...
  const guardarImagenDevolucion = () =>
    setImageURLDevolucion(
      sigCanvasDevolucion.current.getTrimmedCanvas().toDataURL("image/png")
    );
      ...
      <div className="col bg-white p-1 rounded-end">
        ...
        <form>
          ...
          <div className="row mb-4 text-end">
            <label for="colFormLabel" className="col-sm-8 col-form-label">
              FOLIO:
            </label>
          ...
          <div>
            <div className="row g-2 mb-4">
              <div className="col fom-check col-sm-2">
                <label for="colFormLabel" className="col-sm-1 col-form-label">
                  ESTUDIANTE:
                </label>
              </div>
        ...
        <form>
          <div className="mb-4">
            <h4 className="datosLibro fw-bold text-center py-1 mb-4">
              DATOS DEL LIBRO
            </h4>
            <div className="row mb-4">
          ...
          <div className="mb-4 row col-sm-14">
            <label for="selecDate" className="col-sm-3 col-form-label">
              FECHA DE PRESTAMOS:
            </label>
          ...
          <div className="mb-4">
            <Popup
              modal
              trigger={<button type="button">Firma aqui</button>}
              closeOnDocumentClick={false}
            >
              {(close) => (
                <>
                  <SignaturPad
                    ref={sigCanvasSolicitante}
                    canvasProps={{
            ...
            {FirmaSolicitante ? (
              <img src={FirmaSolicitante} alt="Firma" className="firma" />
            ) : null}
          </div>
          <hr className="firmas" />
          <div className="row mb-4">
            <label for="colFormLabel" className="col-sm-6 col-form-label">
              Nombre y Firma del Responsable de Biblioteca:
            </label>
            <div className="col-sm-6">
              <input type="text" className="form-control" />
            </div>
          ...
          <div className="mb-4">
            ...
            {FirmaResponsable ? (
              <img src={FirmaResponsable} alt="Firma" className="firma" />
            ) : null}
          </div>
          <hr className="firmas" />
          <div className="row mb-4">
            <label for="colFormLabel" className="col-sm-6 col-form-label">
              Nombre y Firma de Devolución de la Indentificación:
            </label>
            <div className="col-sm-6">
              <input type="text" className="form-control" />
            </div>
          ...
          <div className="mb-4">
            ...
            {FirmaDevolucion ? (
              <img src={FirmaDevolucion} alt="Firma" className="firma" />
            ) : null}
          </div>
          <hr className="firmas" />
          <Box mb={4}>
            ...
            <div className="d-grid">
              <span>
                <Link
                  className="btn btn-danger nav-link col-2 my-auto mx-auto"
                  to="/"
                >
                  Regresar
                </Link>
...
export default SolicitudPrestamoExterno;
