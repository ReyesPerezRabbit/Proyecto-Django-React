...
const SolicitudPrestamoInterno = () => {
  ...
  const guardarImagenRecibido = () =>
    setImageURLRecibido(
      sigCanvasRecibido.current.getTrimmedCanvas().toDataURL("image/png")
    );
  ...
  const guardarImagenEntregado = () =>
    setImageURLEntregado(
      sigCanvasEntregado.current.getTrimmedCanvas().toDataURL("image/png")
    );
        ...
        <form>
          ...
          <div className="row mb-4">
            <label
              ...
              className="col-sm-1 col-form-label form-label"
            >
              CORREO:
            </label>
            <div className="col-sm-11">
          ...
          <div className="mb-4">
            ...
            {FirmaRecibido ? (
              <img src={FirmaRecibido} alt="Firma" className="firma" />
            ) : null}
          </div>
          <hr className="firmas" />
          <div className="mb-4 row col-sm-12">
            <label for="selecDate" className="col-sm-1 col-form-label">
              FECHA:
            </label>
            <div className="col-sm-2 ">
              <DatePicker
                value={fechaRecibido}
                onChange={cambiarFechaRecibido}
              />
            </div>
          </div>
          <div className="row mb-4">
          ...
          <div className="mb-4">
            ...
            {FirmaEntregado ? (
              <img src={FirmaEntregado} alt="Firma" className="firma" />
            ) : null}
          </div>
          <hr className="firmas" />
          <Box mb={4}>
            ...
            <div className="d-grid">
              <span>
                <Link
                  className="btn btn-success nav-link col-4 my-auto mx-auto"
                  to="/usuario/inicio"
                >
                  Guardar
                </Link>
            ...
            <div className="d-grid">
              <span>
                <Link
                  className="btn btn-danger nav-link col-4 my-auto mx-auto"
                  to="/"
                >
                  Regresar
                </Link>
