  ...
  return (
    <container>
      ...
      <div id="contenedor" class="row">
        ...
        <span><Link className="btn btn-success nav-link" to="/admin">ADMINISTRADOR</Link></span>
        </div>

        <div id="verde" class="col-4 my-auto mx-auto">
        <span><Link className="btn btn-primary nav-link" to="/usuario">USUARIOS</Link></span>
        </div>
      </div>
    </container>
  )
